...
{
	String SELECT_QUERY1 = "SELECT MAX(o.date_of_purchase), c.description, c.image_url, c.name, c.updated_on FROM orders o JOIN course c ON o.course_name=c.name WHERE o.user_email=:email GROUP BY c.name, c.description, c.image_url, c.updated_on";
	...
	Orders findByUserEmailAndCourseName(String userEmail, String courseName);
}
